...
<head>
	...
	<link rel="stylesheet" href="<?= base_url(); ?>assets/css/trackpad-scroll-emulator.min.css" />
	...
	<script src="<?= base_url(); ?>assets/js/jquery.trackpad-scroll-emulator.min.js"></script>
	<script src="<?= base_url(); ?>assets/js/config.js"></script>
	<script src="<?= base_url(); ?>assets/js/service/recipe.js"></script>
	<script src="<?= base_url(); ?>assets/js/script.js"></script>
</head>
<body ng-app="app" data-id="<?= $menu_active; ?>">
...
<div class="container">
	...
	<div class="col-md-12" id="content-body" ng-controller="RecipeController">